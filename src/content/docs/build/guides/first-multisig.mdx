...
<Steps>
  ...
  2. Verify Python installation
     ...
     You should see something like "Python 3.12" or higher.

     <Aside type="caution">
       If you see an error or your Python version is below 3.12, download Python from [python.org](https://python.org/). The Aptos Python SDK requires **Python 3.12+**.
     </Aside>
