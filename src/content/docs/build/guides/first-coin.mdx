...
<Aside type="caution" title="Prefer Fungible Assets">
  The Coin standard is legacy. For new tokens, follow [Your First Fungible Asset](/build/guides/first-fungible-asset) instead. Use this page only if you need to work with existing Coin modules.
</Aside>
...
<Tabs>
  ...
  <TabItem label="Python">
    ...
    The example also needs the MoonCoin Move package from `aptos-core`:
